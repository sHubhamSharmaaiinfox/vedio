    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
      ...
      <aside className={sidebarActive ? "sidebar active " : mobileMenu ? "sidebar sidebar-open" : "sidebar"}>
        ...
        <div className="sidebar-menu-area">
          <ul className="sidebar-menu" id="sidebar-menu">
            <li className="">
              <Link to="#">
                <Icon icon="ion:search-outline" className="menu-icon" />
                <span>Search</span>
              </Link>
            ...
            <li>
            <Link to="/media">
                <Icon icon="fa6-regular:square-plus" className= "menu-icon" />
                <span>Media</span>
                </Link>
            </li>
            <li>
            <Link to="#">
                <Icon icon="ic:baseline-audiotrack" className="menu-icon" />
                <span>Audio</span>
                </Link>
            </li>
            <li>
            ...
            <li>
            <Link to="#">
                <Icon icon="ic:baseline-text-fields" className="menu-icon" />
                <span>Text</span>
                </Link>
            </li>
            <li>
            <Link to="#">
                <Icon icon="ic:baseline-view-module" className="menu-icon" />
                <span>Elements</span>
                </Link>
            </li>
            <li>
            <Link to="#">
                <Icon icon="mdi:record-circle" className="menu-icon" />
                <span>Record</span>
                </Link>
            </li>
      ...
      <main className={sidebarActive ? "dashboard-main active" : "dashboard-main"}>
        ...
        <footer className="d-footer">
          <div className="row align-items-center justify-content-between">
            <div className="col-auto">
              <p className="mb-0">© 2024 Video. All Rights Reserved.</p>
            </div>
            <div className="col-auto">
              <p className="mb-0">
                Made by <span className="text-primary-600">Video</span>
              </p>
            </div>
          </div>
        </footer>
