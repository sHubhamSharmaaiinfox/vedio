...
export default function MenuList() {
  ...
  return (
    <div
      style={{ zIndex: 201 }}
      className="w-14 py-2 absolute top-1/2 -translate-y-1/2 mt-6 left-2.5 bg-zinc-950 rounded-lg shadow-lg flex flex-col overflow-y-auto max-h-screen  items-center"
    >
      <Button
        onClick={() => {
